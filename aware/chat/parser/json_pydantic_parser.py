...
class JsonPydanticParser:
    @staticmethod
    def get_function_schema(name, args, description):
        ...
        # Pass the function to PydanticParser.get_function_schema
        schema = PydanticParser.get_function_schema(dynamic_function)
