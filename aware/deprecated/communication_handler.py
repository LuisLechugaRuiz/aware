...
# TODO: Refactor! Move logic to specific protocols. Maybe we don't need this class and can just use CommunicationProtocols.
class CommunicationHandler:
    ...
    def process_tool_call(
        ...
        # TODO: how to return the proper ProcessToolCallResponse? - we need to get if request_sync scheduled to stop the process.
        if function_response is not None:
            ...
            self.logger.info(
                f"Triggered a communication tool call: {tool_name} with response: {function_response}"
            )
        else:
